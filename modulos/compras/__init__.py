"""
modulos/compras/__init__.py
===========================
Módulo Compras — orquestador de submódulos (Compra, CxP).

Cada submódulo vive en su propio archivo:
    • sub_compra.py  → SubmoduloCompra
    • sub_cxp.py     → SubmoduloCxP
"""
import customtkinter as ctk

from .sub_compra import SubmoduloCompra
from .sub_cxp import SubmoduloCxP
...
class ModuloCompras(ctk.CTkFrame):
    ...
    def _construir_barra_nav(self):
        ...
        self._submodulos = [
            ("Compras.Compra", "🛒 Compra", SubmoduloCompra),
            ("Compras.CxP",    "💳 CxP",    SubmoduloCxP),
        ]
