...
Submódulos:
    ...
    • Entrada en Servicio → SubmoduloEntradaServicio
    • Lista de Equipos  → SubmoduloListaEquipos
"""
import customtkinter as ctk

from .sub_fiscalizar import SubmoduloFiscalizar
from .sub_entrada_servicio import SubmoduloEntradaServicio
from .sub_lista_equipos import SubmoduloListaEquipos
